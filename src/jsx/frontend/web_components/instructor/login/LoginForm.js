...
const InstructorLogin =({classChange}) =>{
	...
	return(
		<>
			<section className="participant-login instructor-login">
					...
					<div className="inner-form">
						<div className="login-frm">
							...
							<form className="form1">
								<h2 className="title">Instructor <span>Login</span></h2>
							...
							<form className="form2">
								<h2 className="title">Instructor <span>Register</span></h2>
								<div className="row">
